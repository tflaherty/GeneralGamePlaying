<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <style type="text/css" media="all"> 
    td.at {        width:  <xsl:value-of select="$width * 0.09"/>px; height: <xsl:value-of select="$height * 0.09"/>px;     margin: 0px; padding: 0px;   border: 1px solid #FFF;  align: center;  valign: middle;    }
