<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template name="board" match="state/fact"> 
    ...
    <xsl:choose>
      <xsl:when test="//fact[relation='control' and argument[1]='p1'] and (//fact[relation='piece' and argument[1]='red' and argument[5]='p1'])[1]">
        <P>p1 (red) to play</P>
      </xsl:when>
      <xsl:when test="//fact[relation='control' and argument[1]='p1'] and (//fact[relation='piece' and argument[1]='black' and argument[5]='p1'])[1]">
        <P>p1 (black) to play</P>
      </xsl:when>
      <xsl:when test="//fact[relation='control' and argument[1]='p2'] and (//fact[relation='piece' and argument[1]='red' and argument[5]='p2'])[1]">
        <P>p2 (red) to play</P>
      </xsl:when>
      <xsl:when test="//fact[relation='control' and argument[1]='p2'] and (//fact[relation='piece' and argument[1]='black' and argument[5]='p2'])[1]">
        <P>p2 (black) to play</P>
      </xsl:when>
