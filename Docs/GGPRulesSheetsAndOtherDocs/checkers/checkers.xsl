...
<table class="grid" width='239' height='180' cellspacing='0' cellpadding='0' border='1'>
  <tr>
    ...
    <td width='30' height='30' align='center' valign='center' style="background-color:#000000">
...
<td width='30' height='30' align='center' valign='center' style="background-color:#FF0000">
  ...
  <xsl:template name="square">
    <xsl:if test="argument[3]='wp'"><img src="D:/AI/Docs/GGPRulesSheetsAndOtherDocs/checkers/white.gif"/></xsl:if>
    <xsl:if test="argument[3]='wk'"><img src="D:/AI/Docs/GGPRulesSheetsAndOtherDocs/checkers/whiteKing.gif"/></xsl:if>
    <xsl:if test="argument[3]='bp'"><img src="D:/AI/Docs/GGPRulesSheetsAndOtherDocs/checkers/brown.gif"/></xsl:if>
    <xsl:if test="argument[3]='bk'"><img src="D:/AI/Docs/GGPRulesSheetsAndOtherDocs/checkers/brownKing.gif"/></xsl:if>
    <xsl:if test="argument[3]='b'"><img src="D:/AI/Docs/GGPRulesSheetsAndOtherDocs/checkers/blank.gif"/></xsl:if>
  </xsl:template>
