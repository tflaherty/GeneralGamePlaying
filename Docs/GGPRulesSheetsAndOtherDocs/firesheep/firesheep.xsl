  ...
  <xsl:template name="sheep" match="state/fact">
    ...
    <xsl:choose>
      <xsl:when test="//fact[relation='sheep' and argument[1]=$index and argument[3]='up']">
        <xsl:attribute   name="style">background-image: url(D:/AI/Docs/GGPRulesSheetsAndOtherDocs/firesheep/sheep_up.png)</xsl:attribute> 
      </xsl:when>  
      <xsl:when test="//fact[relation='sheep' and argument[1]=$index and argument[3]='down']">
        <xsl:attribute   name="style">background-image:  url(D:/AI/Docs/GGPRulesSheetsAndOtherDocs/firesheep/sheep_down.png)</xsl:attribute> 
      </xsl:when>  
      <xsl:when test="//fact[relation='sheep' and argument[1]=$index and argument[3]='left']">
        <xsl:attribute   name="style">background-image:  url(D:/AI/Docs/GGPRulesSheetsAndOtherDocs/firesheep/sheep_left.png)</xsl:attribute> 
      </xsl:when>  
      <xsl:when test="//fact[relation='sheep' and argument[1]=$index and argument[3]='right']">
        <xsl:attribute   name="style">background-image:  url(D:/AI/Docs/GGPRulesSheetsAndOtherDocs/firesheep/sheep_right.png)</xsl:attribute> 
      </xsl:when>  
    </xsl:choose>  
    <xsl:choose>  
