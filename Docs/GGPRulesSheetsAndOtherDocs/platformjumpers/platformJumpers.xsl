<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:choose>   
    <xsl:when test="//fact[relation='jumper' and   argument[2]=$row and argument[3]=$col and argument[1]='red']">  
      <img class="piece"   src="D:/AI/Docs/GGPRulesSheetsAndOtherDocs/platformJumpers/red.png"/> 
    </xsl:when>  
    <xsl:when test="//fact[relation='jumper' and argument[2]=$row and   argument[3]=$col and argument[1]='blue']"> 
      <img class="piece"   src="D:/AI/Docs/GGPRulesSheetsAndOtherDocs/platformJumpers/blue.png"/> 
    </xsl:when> 
  </xsl:choose>
  </center>  
  </td>  
