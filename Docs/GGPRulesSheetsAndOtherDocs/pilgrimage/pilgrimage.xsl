...
<xsl:template name="main" match="/">  
  ...
  <xsl:choose>   
    <xsl:when test="//fact[relation='builder' and   argument[2]=$row and argument[3]=$col and argument[1]='red']">  
      <img class="piece"   src="D:/AI/Docs/GGPRulesSheetsAndOtherDocs/pilgrimage/red.png"/> 
    </xsl:when>  
    <xsl:when test="//fact[relation='builder' and argument[2]=$row and   argument[3]=$col and argument[1]='blue']"> 
      <img class="piece"   src="D:/AI/Docs/GGPRulesSheetsAndOtherDocs/pilgrimage/blue.png"/> 
    </xsl:when> 
    <xsl:when test="//fact[relation='pilgrim' and argument[2]=$row and   argument[3]=$col and argument[1]='red']"> 
      <img class="piece"   src="D:/AI/Docs/GGPRulesSheetsAndOtherDocs/pilgrimage/Red_Bishop.png"/> 
    </xsl:when> 
    <xsl:when test="//fact[relation='pilgrim' and argument[2]=$row and   argument[3]=$col and argument[1]='blue']"> 
      <img class="piece"   src="D:/AI/Docs/GGPRulesSheetsAndOtherDocs/pilgrimage/Blue_Bishop.png"/> 
    </xsl:when> 
  </xsl:choose>
  </center>  
  </td>  
