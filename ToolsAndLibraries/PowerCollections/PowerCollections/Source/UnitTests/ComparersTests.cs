...
namespace Wintellect.PowerCollections.Tests
{
    ...
    public class ComparersTests
    {
        ...
        [ExpectedException("Type \"Wintellect.PowerCollections.Tests.Unorderable\" does not implement IComparable<Wintellect.PowerCollections.Tests.Unorderable> or IComparable.")]
