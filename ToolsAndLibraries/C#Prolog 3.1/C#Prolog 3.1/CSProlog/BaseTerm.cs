  ...
  */
  ...
  public partial class Engine
  {
    ...
    public partial class BaseTerm : ITermNode, IComparable<BaseTerm>
    {
      ...
      public static string VarList (VarStack varStack) //TODO: debugging only
      {
      ...
      */
      ...
      public virtual void TreePrint (int level, Engine e)
      {
        e.Write (Spaces (2*level));

        if (this is OperatorTerm || this is Variable)
